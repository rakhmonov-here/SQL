...
select distinct lastname, Country from customers
...
select iif(Price>1000, 'Expensive','Affordable') as Advice from products
...
case when quantity=1 then '3%'
	 ...
	 else '7%' end as discount_persentage
from orders
